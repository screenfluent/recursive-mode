...
- Durable memory docs must declare the metadata defined by the installed `recursive-mode` artifact template, except `GLOSSARY.md`, which uses the glossary metadata profile in `/.recursive/RECURSIVE.md`.
